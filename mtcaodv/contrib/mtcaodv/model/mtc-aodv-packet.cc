...
{
    static TypeId tid = TypeId("ns3::mtcaodv::TypeHeader")
                            .SetParent<Header>()
...
{
    static TypeId tid = TypeId("ns3::mtcaodv::RreqHeader")
                            .SetParent<Header>()
                            .SetGroupName("MtcAodv")
...
{
    static TypeId tid = TypeId("ns3::mtcaodv::RrepHeader")
                            .SetParent<Header>()
                            .SetGroupName("MtcAodv")
...
{
    static TypeId tid = TypeId("ns3::mtcaodv::RrepAckHeader")
                            .SetParent<Header>()
                            .SetGroupName("MtcAodv")
...
{
    static TypeId tid = TypeId("ns3::mtcaodv::RerrHeader")
                            .SetParent<Header>()
                            .SetGroupName("MtcAodv")
